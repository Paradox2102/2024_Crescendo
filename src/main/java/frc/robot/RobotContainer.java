...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_driverController.rightTrigger().whileTrue(new AutoPickUpGamePiece(
      m_driveSubsystem, 
      m_pivotSubsystem, 
      m_shooterSubsystem, 
      m_holderSubsystem, 
    ...
    // HAHAHHAHAHA JULIA IS COOLER THAN YOU
    ...
    m_driverController.rightBumper().whileTrue(new AutoPickUpGamePiece(m_driveSubsystem, m_pivotSubsystem, m_shooterSubsystem, m_holderSubsystem, () -> m_driverController.getLeftY(), () -> m_driverController.getLeftX(), () -> m_driverController.getRightX()));
    ...
    m_driverController.povUp().onTrue(new ResetGyro(m_driveSubsystem, 0));
    m_driverController.povDown().onTrue(new ResetGyro(m_driveSubsystem, 180));
