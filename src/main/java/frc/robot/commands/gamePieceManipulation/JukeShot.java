...
import frc.robot.commands.IsRotateAimed;
import frc.robot.commands.SetRotatePoint;
...
public class JukeShot extends SequentialCommandGroup {
  ...
  public JukeShot(DriveSubsystem driveSubsystem, ManipulatorSubsystem shooterSubsystem, ManipulatorSubsystem holderSubsystem, Translation2d rotatePoint) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new SetRotatePoint(rotatePoint),
      new ToggleShootSideCommand(false),
      new ParallelDeadlineGroup(
        new IsRotateAimed(driveSubsystem), 
      ...
      new SetRotatePoint(new Translation2d(0, 0)),
