...
public class RobotContainer {
    ...
    public RobotContainer(Robot robot) {
        ...
        NamedCommands.registerCommand("intake",
                new IntakeCommand(m_holderSubsystem, m_shooterSubsystem, m_pivotSubsystem, m_shooterSensors));
    ...
    private void configureBindings() {
        ...
        m_shooterSubsystem
                .setDefaultCommand(
                        new DefaultManipulatorCommand(m_shooterSubsystem, m_driveSubsystem, m_shooterSensors, true));
        m_holderSubsystem
                .setDefaultCommand(
                        new DefaultManipulatorCommand(m_holderSubsystem, m_driveSubsystem, m_shooterSensors, false));
        ...
        m_driverController.leftTrigger()
                .toggleOnTrue(
                        new ShootSequence(m_shooterSubsystem, m_holderSubsystem, m_stickSubsystem, m_shooterSensors));
        ...
        m_joystick.button(8).toggleOnTrue(new FeedCommand(m_shooterSubsystem, m_holderSubsystem, m_shooterSensors));
        m_joystick.button(9).whileTrue(new ManualElevatorCommand(m_elevatorSubsystem, () -> m_joystick.getY()));
        m_joystick.button(10)
                .whileTrue(new EjectSpinCommand(m_driveSubsystem, m_pivotSubsystem, () -> m_joystick.getY()));
