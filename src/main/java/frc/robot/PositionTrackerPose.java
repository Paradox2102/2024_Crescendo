...
public class PositionTrackerPose {
  ...
  public PositionTrackerPose(PositionServer posServer, double x, double y,
    ...
    m_poseEstimator = new SwerveDrivePoseEstimator(
        ...
        ApriltagsCamera.k_odometrySD, ApriltagsCamera.k_visionSD6mm);
  ...
  // 	Logger.log("PositionTrackerPose", 1,
  // String.format("rot=%f,m0=%f,m1=%f,m2=%f,m3=%f,a0=%f,a1=%f,a2=%f,a3=%f",
  // 				rotation.getDegrees(),
  ...
  public void update(ApriltagsCamera camera) {
    ...
    Rotation2d gyro_rotation = m_driveSubsystem.getGyroRotation2d();
    SwerveModulePosition[] modules = m_driveSubsystem.getModulePosition();
    m_poseEstimator.updateWithTime(time, gyro_rotation, modules);
    camera.logUpdate(time, gyro_rotation, modules);
